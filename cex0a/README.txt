...
This program arranges to execute a specified program on another node in
the current machine cluster.  A machine cluster consists of a subset of
those machines that share a common view of the entire filesystem space.
