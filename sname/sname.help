...
This program is meant to be used in "interpreter" files when you want
to interpret SHELL language.  
...
The Shell program being executed by the shell itself (KSH in this case)
will see a fako ARGV (passed from the SHELL) set as :
