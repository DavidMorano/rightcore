...
#define	VECLONG_PREUSE		VECLONG_OREUSE	/* reuse empty entries */
...
extern int veclong_add(veclong *,LONG) ;
extern int veclong_adduniq(veclong *,LONG) ;
...
extern int veclong_find(veclong *,LONG) ;
extern int veclong_match(veclong *,LONG) ;
extern int veclong_search(veclong *,LONG,int (*)()) ;
extern int veclong_getval(veclong *,int,LONG *) ;
extern int veclong_getvec(veclong *,LONG **) ;
