...
#define	varg_alist __builtin_va_alist
#endif

#if defined(__sparcv9)
#define	varg_dcl long varg_alist;
#else
#define	varg_dcl int varg_alist;
#endif
...
#define	varg_starter(list,arg)	\
			list = (char *) &arg
#define	varg_start(list)	\
			list = (char *) &varg_alist
...
#define	varg_copy(to, from)	((to) = (from))
