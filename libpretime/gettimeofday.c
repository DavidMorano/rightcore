...
/*******************************************************************************
	...
	This is a version of |gettimeofday(3c)| that is preloaded to over-ride
...
/* ARGSUSED */
int gettimeofday(struct timeval *tvp,void *dummy)
{
	int		rs ;
...
#if	CF_DEBUGN
	{
	    ...
	    nprintf(NDF,"libpretime_gettimeofday: ent sn=%u\n",sn) ;
	}
#endif
	    rs = 0 ;
	} else {
