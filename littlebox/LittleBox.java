...
class Debug {
	final public static boolean	f_debug = false ;
}
...
scan:
	while (true) {
		...
		if ("v".equals(st.sval)) {
			...
			"fo".equals(st.sval) || "l".equals(st.sval)) {
...
public class LittleBox extends Applet 
	...
	return "LittleBox: David Morano, 1998\n" ;
    }
