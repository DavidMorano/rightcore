...
This command is similar to the 'cat(1}' program except that it is (or
can be) builtin into the SHELL.  Advantages of being built into the
SHELL include the fact that it can be "found" even when the filesystem
that 'cat(1)' resides on cannot be mounted!
