...
The format of an incoming UUMUX job has three parts, the file ID part is first.
Then there are two (possibly repeating) other parts. These are an outer part and
an inner part.
