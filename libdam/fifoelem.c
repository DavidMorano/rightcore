...
int fifoelem_remove(fsp,ebuf,elen)
fifoelem	*fsp ;
void		*ebuf ;
int		elen ;
{
...
int fifoelem_finder(fsp,s,cmpfunc,rpp)
fifoelem	*fsp ;
char		s[] ;
int		(*cmpfunc)() ;
char		**rpp ;
...
static int entry_start(ep,sp,sl)
FIFOELEM_ENT	*ep ;
void		*sp ;
int		sl ;
{
