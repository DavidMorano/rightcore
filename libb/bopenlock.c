...
/*******************************************************************************
        ...
        This subroutine implements a locking strategy based on the existence of
        a file. If the file name given exists already then the lock is not
        captured. If the file does not exist, it is created and the lock is
        captured. To release the lock, one would simply remove the file.
