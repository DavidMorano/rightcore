...
#define	VERSION		"0"
#define	WHATINFO	"@(#)testunodes "
#define	BANNER		"Test PCS UserNodes"
#define	SEARCHNAME	"testunodes"
...
#define	PIDFNAME	"run/testunodes"		/* mutex PID file */
#define	LOGFNAME	"var/log/testunodes"	/* activity log */
#define	LOCKFNAME	"spool/locks/testunodes"	/* lock mutex file */
