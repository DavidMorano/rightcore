...
/* copy a text string converting upper case to lower case */
...
/******************************************************************************
	...
	This is part of the "string package" for the Audix embedded
	firmware code for the Database Processor.
