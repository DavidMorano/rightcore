...
used for ADVICE simulations but it can be used somewhat for other types
of simulations also.  It automatically spawns simulations spanning the
various dimensions of the design space parameters specified (either
explicitly or through the various configuration files).  Simulations
are spawned dynamically based on a combination of factors on the set of
networked computers in the execution pool.



= Dave Morano, 96/04/02
version 0a
