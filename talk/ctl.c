...
#ident	"@(#)ctl.c	1.8	97/07/16 SMI"	/* SVr4.0 1.2	*/
...
#ifdef	COMMENT
	rs = u_setsockopt(ctl_sockt,SOL_SOCKET,SO_KEEPALIVE,
...
void open_sockt()
{
	...
	rs = u_setsockopt(sockt,SOL_SOCKET,SO_KEEPALIVE,
	    (CONST char *) &f_keepalive,sizeof(int)) ;
