...
int vecelem_start(op,esize,n,opts)
vecelem		*op ;
int		esize ;
int		n ;
int		opts ;
...
static int vecelem_setopts(op,options)
VECELEM		*op ;
int		options ;
{
