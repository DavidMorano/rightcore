...
This program accesses the PRT printer database and prints to standard
output the value of the specified keys.

Synopsis:

$ prtdb <key(s)> [-af <argfile>] [-d <printer>] [-u <username>] 
	[-db <dbfile>] [-un <utility>] [-v[=n]] [-Q] [-D] [-V]
