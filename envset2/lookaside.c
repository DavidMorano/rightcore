...
/*******************************************************************************
	...
	allocation and deallocation.  However, memory is never released
	back to 'malloc(3c)' (the origin from which all memory comes)
	once it is allocated.  Freed blocks are, however, available for
