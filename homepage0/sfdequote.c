...
/*******************************************************************************
	...
	This subroutine strips leading and trailing double quote characters
	from the given string.  It also removes leading and trailing white
	space (as defined by 'sfshrink()').
