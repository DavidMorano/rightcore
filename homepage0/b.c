...
extern int	mkpath4w(char *,cchar *,cchar *,cchar *,cchar *,int) ;
...
extern int	progloger_begin(PROGINFO *,cchar *,USERINFO *) ;
extern int	progloger_end(PROGINFO *) ;
extern int	proguserlist_begin(PROGINFO *,cchar *,USERINFO *) ;
...
static int	config_read(CONFIG *,const char *) ;
...
static int	proccmdname(PROGINFO *,char *,int) ;
static int	procresp(PROGINFO *,ARGINFO *,BITS *,cchar *,cchar *,cchar *) ;

static int	procdoc(PROGINFO *,ARGINFO *,BITS *,cchar *,cchar *,cchar *) ;
...
static int	procdocbodymain_svcerinc(PROGINFO *,HTM *,cchar *,int) ;
...
static int	svckey_dequote(const char *(*)[2],int,const char *,cchar **) ;
...
static int proccmdname(PROGINFO *pip,char *rbuf,int rlen)
{
	int		rs ;
...
static int procdocbodymain_svcerinc(PROGINFO *pip,HTM *hdp,cchar *sp,int sl)
{
	int		rs ;
	int		rs1 ;
