...
/*******************************************************************************
	...
	This module provides some character conversion tables for use in the
	'C' locale (using the ISO-Latin-1 character set).  These tables are
	provided for fast conversions when the locale is not necessary to be
	changable.
...
/* all characters recognized by 'isspace(3c)' except NL */
const unsigned char char_iswhite[] = {
...
/* convert characters to their base value (up to base-36) */
const unsigned char char_toval[] = {
