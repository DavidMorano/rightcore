...
/*******************************************************************************
        ...
        This code piece provides for the basic "open" and "close" functions for
        the BFILE I/O library.

        The following global functions are made available from this code piece:
...
static int bfile_bufend(bfile *fp)
{
	int		rs = SR_OK ;
	int		rs1 ;
