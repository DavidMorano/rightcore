...
extern int dater_start(DATER *,struct timeb *,const char *,int) ;
extern int dater_startcopy(DATER *,DATER *) ;
extern int dater_setcopy(DATER *,DATER *) ;
extern int dater_setstd(DATER *,const char *,int) ;
extern int dater_setmsg(DATER *,const char *,int) ;
extern int dater_setstrdig(DATER *,const char *,int) ;
extern int dater_setlogz(DATER *,const char *,int) ;
extern int dater_settouch(DATER *,const char *,int) ;
extern int dater_settoucht(DATER *,const char *,int) ;
extern int dater_settmzon(DATER *,struct tm *,int,const char *,int) ;
extern int dater_settmzo(DATER *,struct tm *,int) ;
extern int dater_settmzn(DATER *,struct tm *,const char *,int) ;
extern int dater_settimezn(DATER *,time_t,const char *,int) ;
extern int dater_settimezon(DATER *,time_t,int,const char *,int) ;
