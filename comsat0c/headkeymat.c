...
/*******************************************************************************
	...
	Given a header key name 'key' such as "Subject", find if it is
	present in the user supplied string given as 'buf'.  Return 0 if
	there is no match, else we return the character position of the
	start of the header value string.  The match is case independent.
