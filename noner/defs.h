...
struct proginfo_flags {
	...
	uint	recurse : 1 ;		/* recurse down directories */
	uint	latin : 1 ;		/* all all Latin-1 characters */
	uint	formfeed : 1 ;		/* allow form-feed characters */
	uint	carriage : 1 ;		/* allow carriage-return characters */
	uint	bell : 1 ;		/* allow bell characters */
	uint	backspace : 1 ;		/* allow backspace characters */
} ;
