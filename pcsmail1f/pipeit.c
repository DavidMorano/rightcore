...
int	f_autoreply ;
{
...
#if	CF_DEBUG
	if (g.f.debug)
	debugprintf("pipeit: we are in NOSEND mode\n") ;
#endif
	...
	savepsig = (void (*)()) signal(SIGPIPE,int_sigpipe) ;
