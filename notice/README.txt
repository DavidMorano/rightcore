...
This program sends a notice to the session terminal of a user if that user is
...
-b		send only to BIFFable terminals
-r		ring bell
-n <number>	send to this number of sessions
